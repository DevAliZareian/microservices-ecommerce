...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='product_service_db'),
        'USER': config('POSTGRES_USER', default='postgres'),
        'PASSWORD': config('POSTGRES_PASSWORD'),
        'HOST': config('POSTGRES_HOST', default='product_db'),
...
USER_SERVICE_URL = config('USER_SERVICE_URL', default='http://user_service:8000')
