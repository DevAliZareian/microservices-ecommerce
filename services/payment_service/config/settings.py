...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='payment_service_db'),
        'USER': config('POSTGRES_USER', default='postgres'),
        'PASSWORD': config('POSTGRES_PASSWORD'),
        'HOST': config('POSTGRES_HOST', default='payment_db'),
...
ORDER_SERVICE_URL = config('ORDER_SERVICE_URL', default='http://order_service:8000')
